...
const MainSection = () => {
    ...
    const DownloadVideo = async () => {
        ...
        try {
            ...
            toast.error("Failed to download the video. Please try again later.");
        } finally {
            setIsLoading(false);
        }
    };
        ...
        <>
            <div className="text-center mt-6 px-6">
                <motion.h1
                    ...
                    initial="hidden"
                    animate="visible"
                    className="my-4 text-2xl font-bold lg:text-6xl capitalize md:uppercase"
                >
                    <span className="font-bold text-pink-600">TikTok Video Downloader</span> - Download High-Quality Videos Without Watermark
                </motion.h1>
                <motion.p
            ...
            <motion.div
                ...
                initial="hidden"
                animate="visible"
                className="w-full md:w-1/2 px-6 flex mt-4 items-center"
            >
                <form
                ...
                >
                    ...
                    />
                    {isLoading ? (
                        <Button color="danger" size="lg" radius="sm" className="ms-1">
                            <Bars
                                height="20"
                                width="100"
                                color="#fff"
            ...
            <motion.div
                ...
                initial="hidden"
                animate="visible"
                className="w-full md:w-1/2 px-6 flex mt-4 justify-center items-center"
            >
            ...
            <div className={Data.length === 0 ? "hidden" : "mt-6 px-6 flex flex-col items-center"}>
                ...
                <div className="my-3 text-center">
                    <Link color="danger" target="_blank" href={Data.url} className="font-semibold text-sm md:text-md text-center">
                        {Data.title}
                    </Link>
                    ...
                    <div className={Downloads.length === 0 ? "hidden" : "flex flex-col justify-center items-center space-y-2"}>
                        {Downloads.map((download: any) => (
                            <Button
                                onClick={() => saveFile(download.url, download.extension)}
                                key={download.size}
                                color="danger"
                                radius="sm"
                                className="w-full"
